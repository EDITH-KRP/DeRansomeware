...
class BlockchainLogger:
    ...
    def __init__(self, network='sepolia', contract_address=None):
        """
    ...
    def _setup_connection(self):
        ...
        try:
            ...
            print(f"Error setting up blockchain connection: {str(e)}")
            self.web3 = None
            self.simulation_mode = True
    ...
    def log_event(self, file_path, event_type, ipfs_hash):
        ...
        if not WEB3_AVAILABLE or not self.web3 or not self.contract or not self.account:
            print("Blockchain connection not properly set up")
            return None
        ...
        try:
            ...
            print(f"Event logged to blockchain. TX Hash: {receipt.transactionHash.hex()}")
    ...
    def get_events(self, from_block=0):
        ...
        if not WEB3_AVAILABLE or not self.web3 or not self.contract:
            print("Blockchain connection not properly set up")
            return []
    ...
    def get_status(self):
        ...
        if WEB3_AVAILABLE and self.web3 and self.web3.is_connected():
            ...
            if self.contract:
                ...
                try:
                    ...
                    status['contractConnected'] = False
